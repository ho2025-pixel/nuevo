...
// Funciones para obtener el código fuente completo de los archivos principales
export function getAdminContextSource(): string {
...
// Reducer implementation with complete functionality
...
export function getCartContextSource(): string {
  return `import React, { createContext, useContext, useReducer, useEffect } from 'react';
...
export function getCheckoutModalSource(): string {
...
export function CheckoutModal({ isOpen, onClose, onCheckout, items, total }: CheckoutModalProps) {
  ...
  const generateOrderText = () => {
    ...
    orderText += \`🚚 Entrega (\${deliveryZone.split(' > ')[2] || deliveryZone}): +$\${deliveryCost.toLocaleString()} CUP\\n\`;
                ...
                <div className="bg-white rounded-xl p-4 border border-gray-200">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      \${deliveryZone.split(' > ')[2] || deliveryZone.split(' > ')[0] || 'Seleccionar zona'}
                    </div>
                  </div>
                </div>
              </div>
...
export function getPriceCardSource(): string {
...
export function getNovelasModalSource(): string {
...
export function getWhatsAppUtilSource(): string {
